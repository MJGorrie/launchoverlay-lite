...
class Launch_Overlay_Settings_Page extends WC_Settings_Page {
	...
	public function inline_admin_css(): void {
		...
		wp_register_style( 'launch-overlay-admin-inline', false );
		wp_enqueue_style( 'launch-overlay-admin-inline' );
		wp_add_inline_style( 'launch-overlay-admin-inline', '
			.lo-pro-badge{
	...
	public function get_settings( $current_section = '' ): array {
		...
		$settings = [
			...
			[
				...
				'default'           => '',
				'css'               => 'min-width:220px;',
				'custom_attributes' => $is_pro ? [] : [ 'disabled' => 'disabled', 'placeholder' => '' ],
			],
			[
